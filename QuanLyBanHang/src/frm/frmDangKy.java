...
public class frmDangKy extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlRegisterInfo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 0)));
        ...
        btnĐangKy.setForeground(new java.awt.Color(0, 153, 0));
        ...
        pnlCopyright.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 0)));
    ...
    private void btnĐangKyActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        //ThongBao("Đã Thêm Thành Công","Thông báo",1);
        ...
        ResultSet rs = this.connection.ExcuteQueryGetTable(cautruyvan);
        try {
            while (rs.next()) {
        ...
        if (MaNhanVien.equals("")) {
            ThongBao("Tên đăng nhập phải từ 5-10 ký tự", "Thông báo lỗi", JOptionPane.ERROR_MESSAGE);
        } else {
            if (TenDangNhap.length() < 5 || TenDangNhap.length() > 10) {
                ...
                ThongBao("Mật khẩu phải nhập nhiều hơn 5 ký tự và ít hơn 50 ký tự", "Lỗi đăng ký", 2);
                ...
                String cautruyvan2 = "select * from USERS where MANV= '" + MaNhanVien + "'";
                ResultSet rs2 = this.connection.ExcuteQueryGetTable(cautruyvan2);
                try {
                    rs2.next();
                    if (rs.getString("MANV").equals(MaNhanVien)) {
                        kt = false;
                ...
                if (kt == true) {
                    ...
                    this.connection.ExcuteQueryUpdateDB(ctv);
                    ThongBao("Đã Thêm Thành Công", "Thông báo", 1);
                } else {
    ...
    private boolean KiemTra(String tdn, String mk) {
        ...
        String cautruyvan = "select * from USERS where TENDANGNHAP= '" + tdn + "' and MATKHAU= '" + mk + "'";
        System.out.println(cautruyvan);
        ResultSet rs = this.connection.ExcuteQueryGetTable(cautruyvan);
